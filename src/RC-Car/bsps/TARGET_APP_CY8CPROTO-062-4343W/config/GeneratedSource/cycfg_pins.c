...
#if defined (CY_USING_HAL) || (CY_USING_HAL_LITE)
const cyhal_resource_inst_t ioss_0_port_13_pin_4_obj =
{
    .type = CYHAL_RSC_GPIO,
    .block_num = ioss_0_port_13_pin_4_PORT_NUM,
    .channel_num = ioss_0_port_13_pin_4_PIN,
};
#endif /* defined (CY_USING_HAL) || (CY_USING_HAL_LITE) */
...
const cy_stc_gpio_pin_config_t USER_LED_config =
{
    .outVal = 1,
    .driveMode = CY_GPIO_DM_STRONG_IN_OFF,
    .hsiom = USER_LED_HSIOM,
    .intEdge = CY_GPIO_INTR_DISABLE,
    .intMask = 0UL,
    .vtrip = CY_GPIO_VTRIP_CMOS,
    .slewRate = CY_GPIO_SLEW_FAST,
...
#if defined (CY_USING_HAL) || (CY_USING_HAL_LITE)
const cyhal_resource_inst_t USER_LED_obj =
{
    .type = CYHAL_RSC_GPIO,
    .block_num = USER_LED_PORT_NUM,
    .channel_num = USER_LED_PIN,
};
#endif /* defined (CY_USING_HAL) || (CY_USING_HAL_LITE) */
...
#if defined (CY_USING_HAL) || (CY_USING_HAL_LITE)
const cyhal_resource_inst_t ioss_0_port_6_pin_5_obj =
{
    .type = CYHAL_RSC_GPIO,
    .block_num = ioss_0_port_6_pin_5_PORT_NUM,
    .channel_num = ioss_0_port_6_pin_5_PIN,
};
#endif /* defined (CY_USING_HAL) || (CY_USING_HAL_LITE) */
...
void reserve_cycfg_pins(void)
{
    ...
    cyhal_hwmgr_reserve(&ioss_0_port_13_pin_4_obj);
    ...
    cyhal_hwmgr_reserve(&ioss_0_port_6_pin_5_obj);
